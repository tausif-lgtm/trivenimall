    ...
    <View style={styles.root}>
      <View style={styles.searchWrap}>
        ...
        <TextInput style={styles.searchInput} value={search} onChangeText={setSearch}
          placeholder="Search incidents..." placeholderTextColor={Colors.textLight} />
      </View>
      <FlatList
        data={filtered}
        ...
        ListEmptyComponent={<EmptyState icon="🚨" title="No incidents reported" subtitle="Report an incident from the dashboard." />}
        renderItem={({ item }) => (
...
const styles = StyleSheet.create({
  ...
  fab: {
    ...
    shadowColor: Colors.danger, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, elevation: 8,
  },
});
